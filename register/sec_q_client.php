...
<html>
	...
	<body class="security_questions">
		<div class="security_questions login">
			...
			?>
			<form action="register_insertion_server.php" method="POST" autocomplete="off">

				<input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($token);?>">
				<input type="hidden" name="token" value="<?php echo htmlspecialchars(hash_hmac('sha256', 'register_insertion_server.php', $_SESSION['second_token']))?>"/>
